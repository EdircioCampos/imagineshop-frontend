        ...
        <StyledFooter>
            <StyledFooterContainer>
                ...
                <StyledSocialMediaLink>
                    <li>
                        <StuledSocialMidiaIcon icon={faFacebookSquare} />
                    </li>
                    <li>
                        <StuledSocialMidiaIcon icon={faInstagram} />
                    </li>
                    <li>
                        <StuledSocialMidiaIcon icon={faYoutube} />
                    </li>
                </StyledSocialMediaLink>
            </StyledFooterContainer>
        </StyledFooter>
...
const StyledSocialMediaLink = styled.ul`
...
const StuledSocialMidiaIcon = styled(FontAwesomeIcon)`
    color: ${({theme}) => theme.colors.secundary};
    font-size: 1.875rem;
`;
